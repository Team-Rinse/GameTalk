...
public class ChatRoom extends JFrame {
	...
	public ChatRoom(String chatId, List<String> participants) {
		...
		topBar.setPreferredSize(new Dimension(307, 60));
		topBar.setBackground(new Color(0xCCDAE7)); // 파스텔 톤의 연한 파란색 계열 배경
		panel.add(topBar, BorderLayout.NORTH);

		// 채팅방 이름 (예: "고모프")
		JLabel chatRoomTitle = new JLabel("고모프");
		...
		// 테스트용 메시지 추가
//        addOtherMessage("HSU 22 김은비", "ㅋㅋㅋㅋㅋㅋ왜 ㅠㅠ");
//        addOtherMessage("HSU 22 하여린", "GOAT");
//        addMyMessage("빼이ㅋㅋ");
//        addImageMessage("HSU 22 김은비", "/icon/sample_image.png"); // 이미지 메시지 예시
//        addVideoMessage("HSU 22 하여린", "/icon/sample_video_thumbnail.png"); // 영상 메시지 예시
	}
